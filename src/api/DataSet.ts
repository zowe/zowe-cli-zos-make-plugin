...
export class DataSet {
     ...
     */
    public static async create(session: ZosmfSession, options: IDatasetAttributes) {
     ...
     */
    public static async exists(session: ZosmfSession, dataset: string): Promise<boolean> {
